...
function _update_ps1() {
    PS1="$(~/go/bin/powerline-go -numeric-exit-codes -modules "aws,kube,newline,venv,ssh,cwd,perms,git,jobs,newline,time,exit,root" \
      -theme ~/.profile.d/powerline-theme/default.json -max-width 75 -cwd-max-depth 6 -error $?)"
}
